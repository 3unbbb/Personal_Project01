...
<%	String sessionId = (String)session.getAttribute("id");
	...
	<form action ="./GalleryUpdateAction.ga?num=${dto.num }&pageNum=<%=pageNum %>;" method = "post" enctype="multipart/form-data">
	...
	<table>
			...
			<tr>
			<td> 제목</td>
			<td colspan = "3"><input type = "text" name = "subject" size ="5" value="${dto.subject }"></td>
			</tr>
			<tr>
			<td> 내용</td>
			<td colspan = "3"><textarea rows = "25" cols="27" name = "content">${dto.content }</textarea></td>
			</tr>
			<tr>
  	 			<td>제품이미지(메인)</td>
